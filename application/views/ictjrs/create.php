        ...
        <form id="ff" class="easyui-form" method="post" data-options="novalidate:true">
            <div style="margin-bottom:5px">
                <div style="margin-bottom:2px">
                    <input class="easyui-textbox" name="requestDescription" id="requestDescription"  style="width:100%; height:50px;" data-options="prompt:'DESCRIPTION OF REQUEST:',multiline:true, required:true">
